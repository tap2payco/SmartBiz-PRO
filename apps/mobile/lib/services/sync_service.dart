        ...
        'changes': {
          ...
          'payments': {
            'created': unsyncedPayments.map((p) => {
              ...
              'createdAt': DateTime.fromMillisecondsSinceEpoch(p['created_at']).toIso8601String(),
            }).toList(),
          },
          'expenses': {
          ...
          'leaves': {
            'created': unsyncedLeaves.map((l) => {
              ...
              'type': l['type'],
              'startDate': DateTime.fromMillisecondsSinceEpoch(l['start_date']).toIso8601String(),
              'endDate': DateTime.fromMillisecondsSinceEpoch(l['end_date']).toIso8601String(),
              'reason': l['reason'],
            }).toList(),
          },
          'suppliers': {
          ...
          'purchases': {
            'created': await Future.wait(unsyncedPurchases.map((p) async {
              ...
              return {
                ...
                'status': p['status'],
                'createdAt': DateTime.fromMillisecondsSinceEpoch(p['created_at']).toIso8601String(),
                'updatedAt': DateTime.fromMillisecondsSinceEpoch(p['updated_at']).toIso8601String(),
                'lineItems': items.map((i) => {
                  'id': i['id'],
                  'itemId': i['item_id'],
                  'quantity': i['quantity'],
